...
const order = () => {
    ...
    const [coordinates, setCoordinates] = useState([
        {
            latitude: 11.09372441639901,
            longitude: 106.66095465828086,
        },
        {
            latitude: 11.094028359042216,
            longitude: 106.6635206260989,
        },
    ]);
    ...
    useEffect(() => {
        (async () => {
            ...
            if (location.coords) {
                ...
                setCoordinates([
                    { latitude, longitude },
                    coordinates[1], // keep the destination point
                ]);
                ...
                <View style={{ padding: 10 }}>
                    <View>
                        ...
                        <Text style={{ textAlign: "center", marginTop: 5, color: "gray" }}>
                            Current Address: {displayCurrentAddress}
                        </Text>
