...
const Index = () => {
    ...
    // Text to display, either error or location details
    let text = 'Waiting..';
    if (errorMsg) {
        text = errorMsg;
    } else if (location) {
    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: "#f8f8f8" }}>
            <View style={{
                ...
                <FontAwesome6 name="map-location-dot" size={24} color="#E52850" />
                <View style={{ flex: 1 }}>
                    <Text style={{ fontSize: 15, fontWeight: "500" }}>Dev Deliver</Text>
